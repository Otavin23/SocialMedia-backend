...
export class CreateUser1711927853370 implements MigrationInterface {
    name = 'CreateUser1711927853370'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "publication" ("id" character varying NOT NULL DEFAULT '17d25317-cded-4306-9e24-6334f6c63e5f', "description" character varying NOT NULL, "comments" jsonb NOT NULL DEFAULT '[]', "like" integer NOT NULL, "heart" integer NOT NULL, "image" character varying NOT NULL, "userId" character varying, CONSTRAINT "PK_8aea8363d5213896a78d8365fab" PRIMARY KEY ("id"))`);
